      ...
      <section className='w-full flex justify-center px-4 pt-24 md:pt-32 pb-16'>
        <div className='flex flex-col gap-6 items-center text-center max-w-3xl'>
          ...
          <p className='text-base md:text-lg text-muted-foreground'>
            En Makrosoft de Colombia entendemos que la agilidad y la eficiencia son claves para el éxito de tu negocio. Por eso, ofrecemos soluciones flexibles de alquiler de computadores, impresoras y multifuncionales, a medida y al alcance de tu empresa.
          </p>
          <p className='text-base md:text-lg text-muted-foreground'>
